...
### Added
- App color schemes in Settings: Standard, Aperitif, and Coastal give the app a cleaner visual range without bringing back team-themed palettes.
...
### Removed
- Removed the old Knicks team color scheme from Settings and replaced it with app-native palette choices.
